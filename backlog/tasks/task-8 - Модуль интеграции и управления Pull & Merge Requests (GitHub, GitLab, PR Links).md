...
## Acceptance Criteria
- [x] Поддержка авторизации в GitHub (через локальный `gh auth token` / OAuth / Personal Access Token) и GitLab.
- [x] Вкладка "Merge / Pull Requests" в карточке проекта со списком активных и закрытых PR/MR.
- [x] Отображение статусов CI/CD проверок (GitHub Actions, GitLab CI), списка измененных файлов и комментариев ревьюеров.
- [x] Создание PR в 1 клик из текущей ветки задачи:
...
- [x] Синхронизация с жизненным циклом задачи Backlog:
