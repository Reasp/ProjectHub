...
12. **Сводная аналитика и активность проекта (Project Analytics Dashboard)** (`task-12`): графики готовности задач, Acceptance Criteria, контрибьюторы Git, статистика LanceDB.
