...
export interface RoleDefinition {
  ...
  provider?: string;
  /**
   * Профиль OpenAI-совместимого провайдера (decision-40): имя или id. Имя переносимо между машинами
   * (id профиля локален), поэтому редактор ролей записывает имя. Важнее `provider`.
   */
  profile?: string;
  model?: string;
  /**
