...
export const PullRequestView: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#0f1117]">
      {/* PR Header Toolbar */}
      <div className="px-6 py-3 border-b border-slate-800 bg-[#12151f]/60 flex items-center justify-between shrink-0">
        <div className="flex items-center gap-3">
          {/* Provider / Repo status */}
          <div className="flex items-center gap-2 text-xs">
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-800/80 border border-slate-700/60 text-slate-300 font-mono text-[11px]">
              <GitPullRequest className="w-3.5 h-3.5 text-indigo-400" />
              {prProviderInfo?.repo || 'Локальный репозиторий'}
            </div>
          ...
          {/* Filter Pills */}
          <div className="flex items-center gap-1 bg-[#0b0d13] p-1 rounded-lg border border-slate-800 text-xs">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            title="Обновить список PR"
            className="p-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-slate-200 border border-slate-700/60 transition disabled:opacity-50"
          >
