      ...
      <div className="w-full h-full flex items-center justify-between gap-2 px-3 py-1 rounded-2xl bg-[#0e111bd9] border border-indigo-500/50 shadow-2xl backdrop-blur-2xl text-xs text-white">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1 truncate text-[11px]">
            {isPaused ? (
              <span className="text-amber-200/90 font-medium truncate block">Ввод на паузе</span>
            ) : isTranscribing ? (
              ...
              <span className="text-emerald-300 font-semibold truncate block">Слушаю речь...</span>
            ) : transcript ? (
        ...
        >
          ...
          <button
            ...
            title={isPaused ? 'Возобновить прослушивание' : 'Поставить на паузу'}
          >
          ...
          <button
            ...
            title="Остановить голосовое управление"
          >
