...
export interface TranslationDictionary {
  ...
  /** Автосудья Swarm Arena (TASK-61, decision-12). */
  judge: {
    title: string;
    subtitle: string;
    runButton: string;
    ...
    componentReview: string;
    componentDiffSize: string;
    ...
    checksNone: string;
    checksRunning: string;
    checkStatusPending: string;
    checkStatusRunning: string;
    checkStatusPassed: string;
    checkStatusFailed: string;
    checkStatusTimeout: string;
    checkStatusSkipped: string;
    ...
    autoMergeOff: string;
    autoMergeDone: string;
    autoMergeSkipped: string;
    autoMergeThreshold: string;
    settingsTitle: string;
    settingsChecks: string;
    settingsWeights: string;
    settingsAutoMerge: string;
    settingsReviewer: string;
    settingsConcurrency: string;
    settingsAddCheck: string;
    settingsCheckName: string;
    settingsCheckCommand: string;
    ...
    settingsReviewerModel: string;
    settingsAutoMergeEnabled: string;
    settingsAutoMergeMinScore: string;
    settingsSave: string;
    settingsCancel: string;
    settingsSaved: string;
    settingsSaveError: string;
    settingsWeightsHint: string;
    settingsChecksHint: string;
    settingsAutoMergeHint: string;
    settingsResetWeights: string;
    composeTitle: string;
    composeHint: string;
    composeApply: string;
    composeSelected: string;
    composeEmpty: string;
    composeDone: string;
    composeError: string;
    judgeError: string;
  ...
  swarm: {
    ...
    costEstimatedTooltip: string;
    estimatedUsageTooltip: string;
    budgetLabel: string;
  ...
  doneLoop: {
    ...
    autoReviewOn: string;
    autoReviewOff: string;
    checksLabel: string;
    checksDesc: string;
    checksLoading: string;
    checksNone: string;
    panelTitle: string;
    ...
    outcomeIterationLimit: string;
    outcomeBudget: string;
    outcomeAgentError: string;
    outcomeTaskError: string;
    outcomeStopped: string;
    decisionRunning: string;
    decisionFinish: string;
    decisionRetry: string;
    decisionFail: string;
    tampered: string;
  ...
  computerUse: {
    ...
    enabledDesc: string;
    runtime: string;
    runtimeState: Record<'stopped' | 'starting' | 'ready' | 'error', string>;
    toolsCount: string;
    unknownTools: string;
    startRuntime: string;
    ...
    outsideDeny: string;
    onlyWindows: string;
    onlyWindowsDesc: string;
    killSwitchTitle: string;
    hotkey: string;
    hotkeyNotRegistered: string;
    takeover: string;
    takeoverDesc: string;
    auditScreenshots: string;
    auditScreenshotsDesc: string;
    killSwitchEngaged: string;
    reason: Record<'hotkey' | 'human-takeover' | 'overlay' | 'manual', string>;
    release: string;
    stop: string;
    diagnostics: string;
  ...
  /** Федерация компьютеров и hub-режим (TASK-66, decision-11). */
  federation: {
    ...
    fieldAddress: string;
    fieldAddressLanHint: string;
    fieldAddressRelayHint: string;
    ...
    status: Record<'idle' | 'connecting' | 'connected' | 'offline' | 'error', string>;
    rights: Record<'readOnly' | 'hitl' | 'full', string>;
    tabOverview: string;
    tabTasks: string;
    tabProcesses: string;
    tabAgents: string;
    ...
    overviewProcesses: string;
    overviewAgents: string;
    overviewHitl: string;
    overviewVersion: string;
    overviewProtocol: string;
    ...
    autoStartAssigned: string;
    autoStartAssignedDesc: string;
  ...
  /** Редактор цен моделей (TASK-70.4, decision-42). */
  pricing: {
    model: string;
    title: string;
    subtitle: string;
    ...
    apply: string;
    cancelEdit: string;
    resetToBuiltin: string;
    remove: string;
    statusBuiltin: string;
    ...
    saved: string;
    unsaved: string;
    importOpenRouter: string;
    importing: string;
    importNote: string;
    importSummary: string;
    importLongContext: string;
    importSearch: string;
    importSelectVisible: string;
    importClear: string;
    importAdd: string;
    importShown: string;
    importError: string;
  ...
  /** Таймлайн агента, чекпоинты и откат (TASK-72, decision-45). */
  agentTimeline: {
    tab: string;
    loading: string;
    empty: string;
    ...
    summary: string;
    summaryCost: string;
    costPartialHint: string;
    filterLabel: string;
    filterAll: string;
    runLabel: string;
    runAfterRewind: string;
    iterationLabel: string;
    runStatus: string;
    colTurn: string;
    colTool: string;
    ...
    colHitl: string;
    turnRow: string;
    toolStatus: Record<'ok' | 'error' | 'running' | 'no_result' | 'not_executed', string>;
    hitlDecision: Record<'requested' | 'allow' | 'deny' | 'expired' | 'cancelled', string>;
    partialCostHint: string;
    notExecutedHint: string;
    switchesTitle: string;
    errorsTitle: string;
    checkpointsTitle: string;
    checkpointsEmpty: string;
    checkpointsDisabledHint: string;
    checkpointKind: Record<'start' | 'turn' | 'end' | 'pre_rewind', string>;
    filesChanged: string;
    rewindButton: string;
    rewindConfirmTitle: string;
    rewindConfirmMessage: string;
    rewindConfirmOk: string;
    rewindDone: string;
    rewindError: string;
    ...
    continueAfterRewind: string;
    rewindBannerTitle: Record<'loop' | 'handoff', string>;
    rewindBannerDesc: Record<'loop' | 'handoff', string>;
    continuationsTitle: string;
    continuationItem: Record<'agent' | 'loop' | 'handoff', string>;
    iterationRolledBack: Record<'full' | 'partial', string>;
    iterationSegment: string;
    stageInvalidated: string;
    stageRerun: string;
    exportTrace: string;
    exportTraceSession: string;
    exportTraceDone: string;
    exportTraceError: string;
    refresh: string;
    units: { ms: string; s: string };
    runStatusLabels: Record<'completed' | 'failed' | 'stopped' | 'budget_exceeded' | 'interrupted' | 'running', string>;
  };
